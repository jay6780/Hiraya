...
import com.shs.app.Activity.Student.StudentSettings.Milscores.milscore_1;
import com.shs.app.Activity.Student.StudentSettings.Milscores.milscore_2;
...
public class Mil_quizActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mil_quiz2);
        getSupportActionBar().setTitle("MIL Quiz");
...
//        mScoreView = findViewById(R.id.score_view);
        ...
        mDatabase = FirebaseDatabase.getInstance().getReference().child("MIL");
        mScoreRef = FirebaseDatabase.getInstance().getReference().child("MIL_score");
        ...
        mDatabase.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists() && dataSnapshot.hasChildren()) {
                    ...
                    Intent intent = new Intent(getApplicationContext(), milscore_1.class);
                    startActivity(intent);
                    overridePendingTransition(0,0);
    ...
    private void startCountdownTimer() {
        ...
        if (!isTimerRunning) {
            ...
            DatabaseReference scoresRef = FirebaseDatabase.getInstance().getReference().child("MIL_score").child(userId);
    ...
    private void pushToWrongAnswers(String questionText, String selectedOption) {
        ...
        if (currentUser != null) {
            ...
            DatabaseReference wrongAnswersRef = FirebaseDatabase.getInstance().getReference().child("MIL_wrong").child(userId);
        ...
        scoresRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(Mil_quizActivity.this);
                    builder.setTitle("Quiz already completed")
                            ...
                            .setPositiveButton("Retake Quiz", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    isTimerPaused = false;
                                    Intent intent = new Intent(getApplicationContext(), Mil_quizActivity.class);
                            ...
                            .setNegativeButton("Cancel", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    Intent intent = new Intent(Mil_quizActivity.this, Student.class);
                                    startActivity(intent);
                                    overridePendingTransition(0,0);
                                    finish();
                                }
    ...
    private void finishQuiz() {
        ...
        scoresRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                // Show results
                Intent intent = new Intent(getApplicationContext(), milscore_2.class);
