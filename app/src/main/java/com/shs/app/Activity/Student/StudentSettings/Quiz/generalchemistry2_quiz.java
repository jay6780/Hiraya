    ...
    import com.shs.app.Activity.Student.StudentSettings.generalChemistryScores.generalchemistry_score1;
    import com.shs.app.Activity.Student.StudentSettings.generalChemistryScores.generalchemistry_score2;
    ...
    public class generalchemistry2_quiz extends AppCompatActivity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            setContentView(R.layout.activity_generalchemistry2_quiz2);
            getSupportActionBar().setTitle("General chemistry2 Quiz");
    ...
    //        mScoreView = findViewById(R.id.score_view);
            ...
            TextTitle = findViewById(R.id.SubjectTitle);


            TextTitle.setText("Quiz in : "+title);
                    ...
                    if (status == TextToSpeech.SUCCESS) {
                        ...
                        if (result == TextToSpeech.LANG_MISSING_DATA || result == TextToSpeech.LANG_NOT_SUPPORTED) {
                            ...
                            speech.setEnabled(true);
                             isTTSEnabled = true;
                            // Set the initial drawable based on TTS state
                            updateSoundButtonDrawable();
                        }
                    } else {
            ...
            mDatabase = FirebaseDatabase.getInstance().getReference().child("generalchemistry2");
            mScoreRef = FirebaseDatabase.getInstance().getReference().child("generalchemistry2_SCORES");
            ...
            mDatabase.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    if (dataSnapshot.exists() && dataSnapshot.hasChildren()) {
                        ...
                        Intent intent = new Intent(getApplicationContext(), generalchemistry_score1.class);
                        startActivity(intent);
                        overridePendingTransition(0,0);
        ...
        private void updateSoundButtonDrawable() {
            int drawableResId = isTTSEnabled ? R.mipmap.mute : R.mipmap.speaker23;
            speech.setImageResource(drawableResId);
        }
        ...
        private void startCountdownTimer() {
            ...
            if (!isTimerRunning) {
                ...
                DatabaseReference scoresRef = FirebaseDatabase.getInstance().getReference().child("generalchemistry2_SCORES").child(userId);
            ...
            mNextButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (isFillInTheBlank && mFillInTheBlankEditText.getText().toString().trim().isEmpty()) {
                        ...
                        checkAnswer();
                        speech.setImageResource(R.mipmap.mute);
                        mCurrentQuestionIndex++;
                        if (mCurrentQuestionIndex < mQuestionList.size()) {
        ...
        private void speakQuestion() {
            if (isTTSEnabled) {
                ...
                float pitch = 2.0f; // Adjust pitch as needed
        ...
        private void pushToWrongAnswers(String questionText, String selectedOption) {
            ...
            if (currentUser != null) {
                ...
                DatabaseReference wrongAnswersRef = FirebaseDatabase.getInstance().getReference().child("generalchemistry2_wrong").child(userId);
            ...
            scoresRef.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    if (dataSnapshot.exists()) {
                        ...
                        AlertDialog.Builder builder = new AlertDialog.Builder(generalchemistry2_quiz.this);
                        builder.setTitle("Quiz already completed")
                                ...
                                .setNegativeButton("Cancel", new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                        ...
                                        Intent intent = new Intent(generalchemistry2_quiz.this, Student.class);
                                        startActivity(intent);
                                        overridePendingTransition(0,0);
                                        finish();
                                    }
        ...
        private void finishQuiz() {
            ...
            scoresRef.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    // Show results
                    Intent intent = new Intent(getApplicationContext(), generalchemistry_score2.class);
