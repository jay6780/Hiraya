package com.shs.app.Activity.Student.StudentSettings.pr2_score;
...
public class pr2_score2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (actionBar != null) {
            actionBar.hide();
            setContentView(R.layout.activity_pr2_score2);
...
// Retrieve score and total questions from Firebase Realtime Database
            ...
            databaseRef.child("Practical_Research2_score").child(currentUser.getUid()).addListenerForSingleValueEvent(new ValueEventListener() {
                @Override
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    if (dataSnapshot.exists()) {
                        ...
                        writtenWorksRef.child(currentUser.getUid()).child("Practical_Research2_written_works").setValue(String.valueOf(quizScore));
                        ...
                        databaseRef.child("Practical_Research2").addListenerForSingleValueEvent(new ValueEventListener() {
                            @Override
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                if (dataSnapshot.exists()) {
