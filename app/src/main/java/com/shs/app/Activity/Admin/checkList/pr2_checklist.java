...
public class pr2_checklist extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pr2_checklist);
...
// Set the color of the title to black
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                if (item.getItemId() == R.id.logout) {
                    ...
                    dialog.logout(pr2_checklist.this);
                    return true;
                }
    ...
    private void retrievePerformanceTaskData3(String studentId, final int rowIndex) {
        DatabaseReference gradeRef = FirebaseDatabase.getInstance().getReference().child("Grade2").child(studentId).child("Practical_Research2_quarterly_assessment");
    ...
    private void retrievePerformanceTaskData2(String studentId, final int rowIndex) {
        DatabaseReference gradeRef = FirebaseDatabase.getInstance().getReference().child("written_works").child(studentId).child("Practical_Research2_written_works");
        gradeRef.addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
    ...
    private void updateTableView() {
        // Create the adapter and decoration after populating studentData
        TableDataAdapter<String[]> customTableDataAdapter = new CustomTableDataAdapter(pr2_checklist.this, studentData);
        ...
        tableView.setHeaderAdapter(new CustomTableHeaderAdapter(pr2_checklist.this,
    ...
    private void showChecklistDialog() {
        ...
        dialog.checklist2(pr2_checklist.this);
