...
import com.shs.app.DialogUtils.pE_dialog.Pe_dialog;
...
public class pE_checklist extends AppCompatActivity implements SearchView.OnQueryTextListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pe_checklist);
...
// Set the color of the title to black
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                if (item.getItemId() == R.id.logout) {
                    ...
                    dialog.logout(pE_checklist.this);
                    return true;
                }
    ...
    private void retrievePerformanceTaskData2(String studentId, final int rowIndex) {
        DatabaseReference gradeRef = FirebaseDatabase.getInstance().getReference().child("written_works").child(studentId).child("Physical_Education_written_works");
        gradeRef.addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
    ...
    private void updateTableView() {
        // Create the adapter and decoration after populating studentData
        TableDataAdapter<String[]> customTableDataAdapter = new CustomTableDataAdapter(pE_checklist.this, studentData);
        ...
        tableView.setHeaderAdapter(new CustomTableHeaderAdapter(pE_checklist.this,
    ...
    private void showChecklistDialog() {
        ...
        dialog.checklist2(pE_checklist.this);
