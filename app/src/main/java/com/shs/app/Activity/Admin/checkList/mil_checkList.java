...
public class mil_checkList extends AppCompatActivity implements SearchView.OnQueryTextListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mil_check_list);
...
// Set the color of the title to black
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                if (item.getItemId() == R.id.logout) {
                    ...
                    dialog.logout(mil_checkList.this);
                    return true;
                }
    ...
    private void deleteDataForStudentDialog() {
        mil_dialog deleteDialog = new mil_dialog(this, studentList);
    ...
    private void retrievePerformanceTaskData2(String studentId, final int rowIndex) {
        DatabaseReference gradeRef = FirebaseDatabase.getInstance().getReference().child("written_works").child(studentId).child("MIL_written_works");
        gradeRef.addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
    ...
    private void updateTableView() {
        // Create the adapter and decoration after populating studentData
        TableDataAdapter<String[]> customTableDataAdapter = new CustomTableDataAdapter(mil_checkList.this, studentData);
        ...
        tableView.setHeaderAdapter(new CustomTableHeaderAdapter(mil_checkList.this,
    ...
    private void showChecklistDialog() {
        ...
        dialog.checklist2(mil_checkList.this);
