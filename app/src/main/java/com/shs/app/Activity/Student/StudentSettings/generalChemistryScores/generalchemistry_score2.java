package com.shs.app.Activity.Student.StudentSettings.generalChemistryScores;
...
public class generalchemistry_score2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (actionBar != null) {
            actionBar.hide();
            setContentView(R.layout.activity_generalchemistry_score2);
...
// Retrieve score and total questions from Firebase Realtime Database
            ...
            databaseRef.child("generalchemistry2_SCORES").child(currentUser.getUid()).addListenerForSingleValueEvent(new ValueEventListener() {
                @Override
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    if (dataSnapshot.exists()) {
                        ...
                        writtenWorksRef.child(currentUser.getUid()).child("general_chemistry_written_works").setValue(String.valueOf(quizScore));
                        ...
                        databaseRef.child("generalchemistry2").addListenerForSingleValueEvent(new ValueEventListener() {
                            @Override
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                if (dataSnapshot.exists()) {
