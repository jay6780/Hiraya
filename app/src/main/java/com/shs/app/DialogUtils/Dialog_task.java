...
public class Dialog_task {
    ...
    public void checklist2(Activity activity) {
        DialogPlus dialog = DialogPlus.newDialog(activity)
                .setContentHolder(new ViewHolder(R.layout.spinner_dialog))
                .setContentWidth(ViewGroup.LayoutParams.MATCH_PARENT)
                .setContentHeight(ViewGroup.LayoutParams.WRAP_CONTENT)
        ...
        Map<String, Class<?>> itemIntentMap = new HashMap<>();
        itemIntentMap.put("Select Subject", null);
        itemIntentMap.put("General Physics2", general_physics2_checklist.class);
        itemIntentMap.put("General Chemistry2", general_chemistry_checklist.class);
        itemIntentMap.put("Practical Research2", pr2_checklist.class);
        itemIntentMap.put("Research Project", research_project_checklist.class);
        itemIntentMap.put("MIL", mil_checkList.class);
        itemIntentMap.put("Physical Education", pE_checklist.class);
