...
public class QuizAdapter2 extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public QuizAdapter2(Context context, List<QuizItem> quizItems, List<String> nodeNames, List<Integer> nodeCounts) {
