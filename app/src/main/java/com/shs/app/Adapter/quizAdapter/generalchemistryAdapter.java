package com.shs.app.Adapter.quizAdapter;
...
import com.shs.app.Activity.Admin.quizManager.PE.peUpdateFill;
import com.shs.app.Activity.Admin.quizManager.PE.pe_multiple_update;
...
import com.shs.app.Activity.Admin.quizManager.QuizSubjects.GenPhysics.generalphysics_multiple_update;
import com.shs.app.Activity.Admin.quizManager.generalChemistryQuiz.generalchemistry2_choiceupdate;
import com.shs.app.Activity.Admin.quizManager.generalChemistryQuiz.generalchemistry2_fill;
import com.shs.app.R;

import java.util.List;

public class generalchemistryAdapter extends RecyclerView.Adapter<generalchemistryAdapter.QuizViewHolder> {
    private Context context;
    private List<DataSnapshot> quizDataSnapshots;

    public generalchemistryAdapter(Context context, List<DataSnapshot> quizDataSnapshots) {
                            ...
                            public void onClick(DialogInterface dialogInterface, int which) {
                                if (which == 0) {
                                    ...
                                    if (option1 == null && option2 == null && option3 == null) {
                                        intent = new Intent(context, generalchemistry2_fill.class);
                                    } else {
                                        intent = new Intent(context, generalchemistry2_choiceupdate.class);
                                    ...
                                    DatabaseReference questionsRef = database.child("generalchemistry2").child(questionId);
