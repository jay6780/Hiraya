...
import com.shs.app.Activity.Admin.quizManager.MIL.Mil_fill_update;
import com.shs.app.Activity.Admin.quizManager.MIL.Mil_update_choice;
import com.shs.app.Activity.Admin.quizManager.Reseach_project.R_project_choice_update;
import com.shs.app.Activity.Admin.quizManager.Reseach_project.R_project_fill_update;
import com.shs.app.R;

import java.util.List;

public class Mil_Adapter extends RecyclerView.Adapter<Mil_Adapter.QuizViewHolder> {
    private Context context;
    private List<DataSnapshot> quizDataSnapshots;

    public Mil_Adapter(Context context, List<DataSnapshot> quizDataSnapshots) {
                            ...
                            public void onClick(DialogInterface dialogInterface, int which) {
                                if (which == 0) {
                                    ...
                                    if (option1 == null && option2 == null && option3 == null) {
                                        intent = new Intent(context, Mil_fill_update.class);
                                    } else {
                                        intent = new Intent(context, Mil_update_choice.class);
                                    ...
                                    DatabaseReference questionsRef = database.child("MIL").child(questionId);
