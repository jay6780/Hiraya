...
import com.shs.app.Activity.Admin.quizManager.practicalResearch2.pr2Update_choice;
import com.shs.app.Activity.Admin.quizManager.practicalResearch2.pr2Update_fill;
import com.shs.app.R;

import java.util.List;

public class Practical_Research2_adapter extends RecyclerView.Adapter< Practical_Research2_adapter.QuizViewHolder> {
    private Context context;
    private List<DataSnapshot> quizDataSnapshots;

    public  Practical_Research2_adapter(Context context, List<DataSnapshot> quizDataSnapshots) {
                            ...
                            public void onClick(DialogInterface dialogInterface, int which) {
                                if (which == 0) {
                                    ...
                                    if (option1 == null && option2 == null && option3 == null) {
                                        intent = new Intent(context, pr2Update_fill.class);
                                    } else {
                                        intent = new Intent(context, pr2Update_choice.class);
