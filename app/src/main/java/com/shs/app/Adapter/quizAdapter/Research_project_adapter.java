...
public class Research_project_adapter extends RecyclerView.Adapter<Research_project_adapter.QuizViewHolder> {
    private Context context;
    private List<DataSnapshot> quizDataSnapshots;

    public Research_project_adapter(Context context, List<DataSnapshot> quizDataSnapshots) {
                            ...
                            public void onClick(DialogInterface dialogInterface, int which) {
                                if (which == 0) {
                                    ...
                                    if (option1 == null && option2 == null && option3 == null) {
                                        intent = new Intent(context, R_project_fill_update.class);
                                    } else {
                                        intent = new Intent(context, R_project_choice_update.class);
                                    ...
                                    DatabaseReference questionsRef = database.child("Research_project").child(questionId);
