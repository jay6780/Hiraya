...
public class PeAdapter extends RecyclerView.Adapter<PeAdapter.QuizViewHolder> {
    private Context context;
    private List<DataSnapshot> quizDataSnapshots;

    public PeAdapter(Context context, List<DataSnapshot> quizDataSnapshots) {
                            ...
                            public void onClick(DialogInterface dialogInterface, int which) {
                                if (which == 0) {
                                    ...
                                    if (option1 == null && option2 == null && option3 == null) {
                                        intent = new Intent(context, peUpdateFill.class);
                                    } else {
                                        intent = new Intent(context, pe_multiple_update.class);
                                    ...
                                    DatabaseReference questionsRef = database.child("PE").child(questionId);
