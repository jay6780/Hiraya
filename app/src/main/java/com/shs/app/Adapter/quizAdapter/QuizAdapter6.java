...
public class QuizAdapter6 extends RecyclerView.Adapter<QuizAdapter6.QuizViewHolder> {
    private Context context;
    private List<DataSnapshot> quizDataSnapshots;

    public QuizAdapter6(Context context, List<DataSnapshot> quizDataSnapshots) {
                            ...
                            public void onClick(DialogInterface dialogInterface, int which) {
                                if (which == 0) {
                                    ...
                                    if (option1 == null && option2 == null && option3 == null) {
                                        intent = new Intent(context, generalphysics_fill_update.class);
                                    } else {
                                        intent = new Intent(context, generalphysics_multiple_update.class);
                                    ...
                                    DatabaseReference questionsRef = database.child("Gen_Physics2").child(questionId);
